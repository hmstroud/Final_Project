...
```{r Relationships with Open Space, warning= FALSE}
...
ggplot(SoVI_neighborhood, aes( x= Storm.Water.Priorities, y=composite)) + 
  geom_boxplot()

ggplot(SoVI_neighborhood, aes( y= Emergency.Services.Hotspots, x=composite)) + 
  geom_point() 

ggplot(SoVI_neighborhood, aes( x= Temperature.Hot.Spots, y=composite)) + 
  geom_boxplot() 
